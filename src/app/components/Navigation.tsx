...
export function Navigation() {
  ...
  return (
    <motion.nav
      ...
      style={{
        background: scrolled ? "rgba(4, 17, 30, 0.92)" : "transparent",
        ...
        <div className="flex items-center justify-between h-20">
          <div className="flex items-center gap-2.5">
            <div
              ...
              style={{
                background: "linear-gradient(135deg, #00D4E8, #0B2D52)",
              }}
            >
          ...
          >
            {mobileMenuOpen ? (
              ...
              <Menu
                size={24}
                style={{ color: scrolled ? "#FFFFFF" : "#FFFFFF" }}
              />
            )}
          </button>
        </div>
