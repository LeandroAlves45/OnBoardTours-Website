...
export function Contact() {
  ...
  const contactInfo = [
    {
      icon: MapPin,
      label: "Location",
      value: "Gate A, R. da Praia 110, Porto",
    },
    {
      icon: Clock,
      label: "Hours",
  ...
  return (
    <section
      ...
      style={{
        background:
          "linear-gradient(160deg, #04111E 0%, #071830 40%, #0B2D52 80%, #071830 100%)",
      }}
    >
      {/* Ambient glows */}
      <div className="absolute inset-0 pointer-events-none">
        <div
          className="absolute top-1/2 left-0 w-[500px] h-[500px] -translate-y-1/2 rounded-full blur-[150px]"
          style={{
            background:
              "radial-gradient(circle, rgba(0,212,232,0.07) 0%, transparent 70%)",
          }}
        />
        <div
          className="absolute top-1/2 right-0 w-[400px] h-[400px] -translate-y-1/2 rounded-full blur-[120px]"
          style={{
            background:
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(90deg, transparent, rgba(0,212,232,0.4), transparent)",
          }}
        />
      </div>
          ...
          <div>
            ...
            <Reveal delay={0.24}>
              <div
                ...
                style={{
                  background:
                    "linear-gradient(90deg, rgba(0,212,232,0.2), transparent)",
                }}
              />
            </Reveal>
          </div>
              ...
              return (
                <motion.button
                  ...
                  onMouseEnter={(e) => {
                    (e.currentTarget as HTMLElement).style.boxShadow =
                      `0 8px 32px ${button.accentColor}22`;
                    (e.currentTarget as HTMLElement).style.borderColor =
                      `${button.accentColor}44`;
                  }}
                  onMouseLeave={(e) => {
                ...
                >
                  ...
                  <div
                    ...
                    style={{
                      background: `radial-gradient(circle at 0% 50%, ${button.accentColor}0F 0%, transparent 60%)`,
                    }}
                  />
